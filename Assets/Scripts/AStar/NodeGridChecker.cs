...
public class NodeGridChecker : MonoBehaviour
{
    public static NodeGridChecker instance;
    ...
    public void CreateGrid()
    {
        ...
        for (int x = 0; x < gridSizeX; x++)
        {
            for (int y = 0; y < gridSizeY; y++)
            {
                ...
                bool walkable = !(Physics.CheckSphere(worldPoint, nodeRadius, unwalkableMask) || Physics.CheckSphere(worldPoint, nodeRadius, temporarilyUnwalkableMask));
                grid[x, y] = new AStarNode(walkable, worldPoint, x, y);
            }
        }

        //print("Done creating check grid");
    }
